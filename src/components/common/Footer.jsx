...
function Footer() {
	return (
		<div className="bg-richblack-800">
			<div className="flex lg:flex-row gap-8 items-center justify-between w-10/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-6">
			...
			<div className="flex flex-row items-center justify-between w-10/12 max-w-maxContent text-richblack-400 mx-auto  pb-6 text-sm">
				{/* Section 3 */}
				<div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
					...
					<div className="text-center">Made with ❤️ AnujGupta © 2025 Studynotion</div>
				</div>
			</div>
		</div>
	);
