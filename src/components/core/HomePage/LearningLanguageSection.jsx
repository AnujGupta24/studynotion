		...
		<div className="mt-[90px] mb-[100px]">
			<div className="flex flex-col items-center gap-5">
				<h2 className="text-4xl text-center font-semibold">
					...
					<HighlightText text={'learn any language'} className="font-bold text-richblue-200" />
				</h2>
				...
				<div className="flex items-center justify-center mt-3">
					<img src={know_your_progress} className="object-contain -mr-44" alt="knowyourprogressimage " />
					<img src={compare_with_others} className="object-contain" alt="comparewithothersimage" />
					<img
